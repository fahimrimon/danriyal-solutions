...
function AboutUs() {
  return (
    <div name='about' className='mt-36 lg:mt-36 mx-8 lg:mx-36'>
        ...
        <h2 className='text-2xl font-semibold mb-4'>Need to know about the Company</h2>
        <h2 className='text-base text-lg mb-16'>Danriyal Solutions Technologies, Bangladesh based custom software development & consulting company focusing on web, mobile, AI, desktop & embedded software development. We always try to provide good service to the client so that they always have atrust in us.</h2>
        </div>
      <div className='lg:grid lg:grid-cols-2 gap-4'>
        ...
        <h2 className='text-base text-lg text-black subpixel-antialiased mt-4'>Our company started with some of our friends. The aim of all of them was to bring the world's best ranking with good service by showing their work skiils.</h2>
        </div>
        </div>
      </div>
  )
