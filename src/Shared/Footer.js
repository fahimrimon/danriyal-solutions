...
function Footer() {
  ...
  <div>
    ...
    <Link to=''><a href='/' className='text-base'>About</a></Link>
    <Link to=''><a href='/' className='text-base'>Services</a></Link>
    <Link to=''><a href='/' className='text-base'>Blogs</a></Link>
    <Link to=''><a href='/' className='text-base'>Contact Us</a></Link>
  </div> 
  <div className='lg:place-self-center lg:justify-self-end'>
    <span class="text-lg font-bold mb-2">Connect with us</span> 
    <div class="grid grid-flow-col gap-4 ml-4">
