  ...
  <div className="navbar-start lg:ml-8">
    <div className="dropdown">
      ...
      <ul tabindex="0" className="menu menu-compact dropdown-content mt-3 p-2 shadow bg-base-100 rounded-box w-52">
        <li><Link to='footer' smooth={true} duration={500}><a className='text-lg font-semibold'>About</a></Link></li>
        <li><Link to='footer' smooth={true} duration={500}><a className='text-lg font-semibold'>Services</a></Link></li>
        <li><Link to='footer' smooth={true} duration={500}><a className='text-lg font-semibold'>Blogs</a></Link></li>
        <li><Link to='footer' smooth={true} duration={500}><a className='text-lg font-semibold'>Contact Us</a></Link></li>
      </ul>
    </div>
